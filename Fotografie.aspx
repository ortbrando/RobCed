<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fotografie.aspx.cs" Inherits="Fotografie" %>
<!DOCTYPE html>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active">
                        <a href="Fotografie.aspx"  style="color: black; text-decoration: underline;">fotomomenti</a>
                    </li>
                    <li>
